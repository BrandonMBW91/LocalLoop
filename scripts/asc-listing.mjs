...
const DESCRIPTION = `Everything happening around Northwest, Central, and Northeast Ohio, in one free app.

Local Loop brings together local events, garage sales, and food trucks across 79 towns, so you never have to dig through a dozen Facebook pages and websites to figure out what to do this weekend.
...
Towns include Findlay, Toledo, Lima, Akron, Canton, Youngstown, Sandusky, Bowling Green, Mansfield, Marion, and dozens more across Northwest, Central, and Northeast Ohio.`;

const WHATS_NEW = `Local Loop now covers 79 towns across Northwest, Central, and Northeast Ohio, from Toledo and Findlay to Akron, Canton, and Youngstown. Plus a new map view: see what's on around you, then zoom out to catch nearby towns.`;
